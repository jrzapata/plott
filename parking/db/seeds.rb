...
jzspot2 = Spot.create(address: "bladsfasdfasd", zipcode: "12311", available: true, price: 15, description: "blahadsfas asdf")

jzspot3 = Spot.create(address: "bladsfasdfasd", zipcode: "12311", available: true, price: 15, description: "blahadsfas asdf")


jordan.spots << jzspot

jordan.spots << jzspot2

jordan.spots << jzspot3

sam = Customer.create(first_name: "Sam", last_name: "Langford", make: "Ford", model: "Mustang")

sam.spots << jzspot

jzspot.update(available: false)

josh = Customer.create(first_name: "Josh", last_name: "Davis", make: "Toyota", model: "Camry")

josh.spots << jzspot2

jzspot2.update(available: false)
